...
//////////////***These test started failing after my VM was udpated, it is due to write acess denied****/////////
...
@SpringBootApplication(scanBasePackages = "com.valtech.controller")
...
public class FileUploadIntegrationTests {
	...
	public void shouldUploadFile() throws Exception {
		...
		then(storageService).should().processFile(any(MultipartFile.class));
		
		//////////////***This test started failing after my VM was udpated, it is due to write acess denied****/////////
